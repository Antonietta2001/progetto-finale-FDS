In this folder you can find input files and output files related to the Python script `backtest.py`.
...
- backtest_H10_criterionB_DSRVAL_top5_ensemble_report.json
